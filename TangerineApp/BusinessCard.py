...
# Load the virtual business card image
business_card = cv2.imread('business_card.png')
...
while True:
    ...
    if tracking_roi is not None:
        ...
        # Overlay the virtual business card on top of the tracked tangerine
        business_card_resized = cv2.resize(business_card, (tracking_roi[2], tracking_roi[3]))
        frame[tracking_roi[1]:tracking_roi[1]+tracking_roi[3], tracking_roi[0]:tracking_roi[0]+tracking_roi[2]] = business_card_resized
